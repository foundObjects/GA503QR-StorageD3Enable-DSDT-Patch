...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x0107200A)
{
    ...
    External (_SB_.M046, DeviceObj)
    External (_SB_.M047, DeviceObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xEC2F1000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xEC2F5000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xEC52CC98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xEC52C998, 0x0C)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xEC51A000, 0x0100)
    ...
    Scope (_SB)
    {
        OperationRegion (ACUO, SystemMemory, ACUB, 0x12)
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, Serialized)
            {
                ...
                If ((Local0 == 0x53545344))
                {
                    ...
                    If ((IIA0 == 0x00120079))
                    {
                        Local0 = GSRV (0x0006F05C)
                        Local0 >>= 0x18
                        Local0 *= 0x0271
                        Local0 = (0x00025D78 - Local0)
                ...
                If ((Local0 == 0x53564544))
                {
                    ...
                    If ((IIA0 == 0x0012007A))
                    {
                        ...
                        If ((^^PCI0.SBRG.EC0.NTWF == One))
                        {
                            Notify (NPCF, 0xC1) // Hardware-Specific
                            ^^PCI0.SBRG.EC0.NTWF = Zero
                        }
    ...
    Scope (_SB.PCI0.GPP2.CADR)
    {
        Name (DGPS, Zero)
        Name (_PSC, Zero)  // _PSC: Power State Current
        OperationRegion (CROP, SystemMemory, (0xF0000000 + (SBUN << 0x14)), 0x1000)
    ...
    Scope (_SB.PCI0.GPP2)
    {
        OperationRegion (CRRP, SystemMemory, 0xF000B000, 0x1000)
        ...
        PowerResource (RPR2, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                Return (PRFF) /* \_SB_.PCI0.GPP2.PRFF */
            }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Scope (GPP5)
        {
            PowerResource (P1NV, 0x00, 0x0000)
            {
                Name (D1NV, One)
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    TPST (0x70AA)
                    Return (D1NV) /* \_SB_.PCI0.GPP5.P1NV.D1NV */
                }
                ...
                Method (_ON, 0, NotSerialized)  // _ON_: Power On
                {
                    ...
                    If ((CNSB == One))
                    {
                        ...
                        If ((OBRI != 0xFF))
                        {
                            Local1 = PXCR (OBRI, Zero, Zero)
                            M020 (OBRI, Zero, Zero, (Local1 + 0x08), QXDC)
                            M020 (OBRI, Zero, Zero, (Local1 + 0x10), (QXLC & 0xFFFFFEFC))
                            M020 (OBRI, Zero, Zero, (Local1 + 0x28), QXD2)
                            M020 (OBRI, Zero, Zero, 0x10, OBAR)
                            M020 (OBRI, Zero, Zero, 0x04, (OCMD | 0x06))
                            APMC = 0xD8
                        }
                    }
                ...
                Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
                {
                    If ((CNSB == One))
                    {
                        Local0 = M019 (Zero, 0x02, 0x03, 0x18)
                        OBRI = ((Local0 & 0xFF00) >> 0x08)
                        If ((OBRI != 0xFF))
                        {
                            OCMD = M019 (OBRI, Zero, Zero, 0x04)
                            OBAR = M019 (OBRI, Zero, Zero, 0x10)
                            Local1 = PXCR (OBRI, Zero, Zero)
                            QXDC = M019 (OBRI, Zero, Zero, (Local1 + 0x08))
                            QXLC = M019 (OBRI, Zero, Zero, (Local1 + 0x10))
                            QXD2 = M019 (OBRI, Zero, Zero, (Local1 + 0x28))
                            D1NV = Zero
                        }
                    }
                }
    ...
    Scope (_SB.PCI0.GPP4.WLAN)
    {
        ...
        If ((VIDS == 0x14C3))
        {
            ...
            {
                EWR2 [0x04] = STXE /* \_SB_.STXE */
                EWR2 [0x07] = ST10 /* \_SB_.ST10 */
                EWR2 [0x08] = ST11 /* \_SB_.ST11 */
                EWR2 [0x09] = ST12 /* \_SB_.ST12 */
                EWR2 [0x0A] = ST13 /* \_SB_.ST13 */
                EWR2 [0x0B] = ST14 /* \_SB_.ST14 */
                EWR2 [0x0D] = ST20 /* \_SB_.ST20 */
                EWR2 [0x0E] = ST21 /* \_SB_.ST21 */
                EWR2 [0x0F] = ST22 /* \_SB_.ST22 */
                EWR2 [0x10] = ST23 /* \_SB_.ST23 */
                EWR2 [0x11] = ST24 /* \_SB_.ST24 */
                Return (EWR2) /* \_SB_.PCI0.GPP4.WLAN.EWR2 */
            }
        }
        ...
        If ((VIDS == 0x14C3))
        {
            ...
            {
                WGD2 [0x07] = SD11 /* \_SB_.SD11 */
                WGD2 [0x08] = SD12 /* \_SB_.SD12 */
                WGD2 [0x09] = SD14 /* \_SB_.SD14 */
                WGD2 [0x0A] = SD15 /* \_SB_.SD15 */
                WGD2 [0x0C] = SD21 /* \_SB_.SD21 */
                WGD2 [0x0D] = SD22 /* \_SB_.SD22 */
                WGD2 [0x0E] = SD24 /* \_SB_.SD24 */
                WGD2 [0x0F] = SD25 /* \_SB_.SD25 */
                WGD2 [0x11] = SD31 /* \_SB_.SD31 */
                WGD2 [0x12] = SD32 /* \_SB_.SD32 */
                WGD2 [0x13] = SD34 /* \_SB_.SD34 */
                WGD2 [0x14] = SD35 /* \_SB_.SD35 */
                WGD2 [0x16] = SD41 /* \_SB_.SD41 */
                WGD2 [0x17] = SD42 /* \_SB_.SD42 */
                WGD2 [0x18] = SD44 /* \_SB_.SD44 */
                WGD2 [0x19] = SD45 /* \_SB_.SD45 */
                WGD2 [0x1B] = SD51 /* \_SB_.SD51 */
                WGD2 [0x1C] = SD52 /* \_SB_.SD52 */
                WGD2 [0x1D] = SD54 /* \_SB_.SD54 */
                WGD2 [0x1E] = SD55 /* \_SB_.SD55 */
                Return (WGD2) /* \_SB_.PCI0.GPP4.WLAN.WGD2 */
            }
        }
    }
}
